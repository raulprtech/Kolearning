            ...
            <DialogContent>
                <DialogHeader>
                    <div className="flex flex-col items-center text-center">
                        ...
                        <DialogTitle className="text-3xl font-headline">Project Completed!</DialogTitle>
                        <DialogDescription>
                            Congratulations! You have mastered "{project.title}".
                        </DialogDescription>
                    </div>
                </DialogHeader>
                <div className="my-6">
                    ...
                    <p className="text-sm text-muted-foreground text-center mt-6">
                        The Tutor will schedule review sessions to help you retain this knowledge in the long term.
                    </p>
                </div>
