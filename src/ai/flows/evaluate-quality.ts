...
export type EvaluateQualityInput = z.infer<typeof EvaluateQualityInputSchema>;
...
export type EvaluateQualityOutput = z.infer<typeof EvaluateQualityOutputSchema>;
...
export async function evaluateQuality(input: EvaluateQualityInput): Promise<EvaluateQualityOutput> {
