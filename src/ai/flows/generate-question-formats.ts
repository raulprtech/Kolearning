...
export type GenerateQuestionFormatsInput = z.infer<typeof GenerateQuestionFormatsInputSchema>;
...
export type GenerateQuestionFormatsOutput = z.infer<typeof GenerateQuestionFormatsOutputSchema>;
...
export async function generateQuestionFormats(input: GenerateQuestionFormatsInput): Promise<GenerateQuestionFormatsOutput> {
