...
export type EvaluateReasoningInput = z.infer<typeof EvaluateReasoningInputSchema>;
...
export type EvaluateReasoningOutput = z.infer<typeof EvaluateReasoningOutputSchema>;

export async function evaluateReasoning(input: EvaluateReasoningInput): Promise<EvaluateReasoningOutput> {
