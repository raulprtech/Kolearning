...
export type ExtractContextualConceptsInput = z.infer<typeof ExtractContextualConceptsInputSchema>;
...
export type ExtractContextualConceptsOutput = z.infer<typeof ExtractContextualConceptsOutputSchema>;
...
export async function extractContextualConcepts(input: ExtractContextualConceptsInput): Promise<ExtractContextualConceptsOutput> {
