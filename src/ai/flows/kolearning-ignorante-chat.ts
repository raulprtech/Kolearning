...
export type KolearningIgnoranteInput = z.infer<typeof KolearningIgnoranteInputSchema>;
...
export type KolearningIgnoranteOutput = z.infer<typeof KolearningIgnoranteOutputSchema>;

export async function kolearningIgnoranteRespond(input: KolearningIgnoranteInput): Promise<KolearningIgnoranteOutput> {
