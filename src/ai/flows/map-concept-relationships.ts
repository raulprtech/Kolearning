...
export type MapConceptRelationshipsInput = z.infer<typeof MapConceptRelationshipsInputSchema>;
...
export type MapConceptRelationshipsOutput = z.infer<typeof MapConceptRelationshipsOutputSchema>;
...
export async function mapConceptRelationships(input: MapConceptRelationshipsInput): Promise<MapConceptRelationshipsOutput> {
