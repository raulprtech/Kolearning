...
// Inferir el tipo de datos del formulario
...
export default function LoginPage() {
  ...
  const handleSignUp = async ({ email, password }: FormData) => {
    ...
    try {
      ...
      // Crear usuario en Firestore a través del API
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const { user } = result;
      // Crear o actualizar usuario en Firestore a través del API
      await fetch('/api/user', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const renderForm = (isLogin: boolean) => (
    <>
      ...
      <Button
        ...
        disabled={loading}
      >
        {/* Simple SVG para el logo de Google */}
