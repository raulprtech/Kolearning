...
- Primary color: Deep purple (#6750A4), chosen to evoke intellect, strategy, and a sense of refined learning.
- Background color: Light grey (#F2F0F4), providing a clean, distraction-free surface that emphasizes clarity and focus.
- Accent color: Muted plum (#99499E), carefully selected to highlight interactive elements while preserving a calming, studious vibe.
- Body font: 'Inter', a grotesque-style sans-serif (modern, machined, objective, neutral look).
- Headline font: 'Space Grotesk', a proportional sans-serif with a computerized, techy, scientific feel. This will be used to ensure visual hierarchy and overall consistency, which contributes to enhanced readability and aesthetics. Use 'Space Grotesk' for headlines and 'Inter' for body.
- Use minimalist icons to represent actions and resources like energy and credits, and abstract representations for entities.
- Maintain a clean and structured layout to enhance the sense of order and strategic planning, reflecting the core user motivation.