...
export class WhatsAppConector {
    ...
    register() {
        ...
        HookRegistry.addAction('on_task_executed', async (data) => {
            ...
            const message = `🚀 *Kolearning - Tarea Completada*\n\n` +
                ...
                `💡 *Resumen:* ${((_a = data.result) === null || _a === void 0 ? void 0 : _a.summary) || 'No hay resumen disponible'}\n\n` +
    ...
    async connectToWhatsApp() {
        ...
        this.socket.ev.on('messages.upsert', async (m) => {
            ...
            const text = msg.message.conversation || ((_a = msg.message.extendedTextMessage) === null || _a === void 0 ? void 0 : _a.text);
            if (text) {
