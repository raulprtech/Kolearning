...
const hintPrompt = ai.definePrompt({
    ...
    prompt: `You are the Kolearning Tutor, an expert AI tutor. A learner has requested a hint for the following question.
...
const rephrasePrompt = ai.definePrompt({
    ...
    prompt: `You are the Kolearning Tutor, an expert AI tutor. A learner has requested that you rephrase the following question to make it easier to understand.
