...
const calibratePlanFlow = ai.defineFlow({
    ...
    const result = Object.assign(Object.assign({}, output), { atoms: input.atoms, learningPath: processedLearningPath, kolearningJustification: output.kolearningJustification || 'Automatically generated plan by Kolearning.', expectedProgress: output.expectedProgress || 'Expected progress based on the study plan.', fullLearningPlanMarkdown: output.fullLearningPlanMarkdown || '' });
    return result;
});
